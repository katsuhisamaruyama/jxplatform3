...
public class TypeTokenSubtypeTest extends TestCase {
  ...
  private static class WildcardSubtypingTests extends SubtypeTester {
    ...
    @TestSubtype(suppressGetSupertype = true, suppressGetSubtype = true)
    public UseList<? extends List<? extends Enum<?>>>
    ...
    @TestSubtype(suppressGetSupertype = true, suppressGetSubtype = true)
    public List<MyTypeBoundUsesImplicitBound<?>> typeVariableBoundOmitsItsOwnBound(
        List<MyTypeBoundUsesImplicitBound<?>> arg) {
      return isSubtype(arg);
    }

    @TestSubtype(suppressGetSupertype = true, suppressGetSubtype = true)
    public List<MyTypeBoundUsesImplicitBound<?>>
    ...
    @TestSubtype(suppressGetSupertype = true, suppressGetSubtype = true)
    public Iterable<UseSerializableIterable<?>>
    ...
    @TestSubtype(suppressGetSupertype = true, suppressGetSubtype = true)
    public Iterable<UseList<?>> useListOfIterableWildcard(
