...
public class SDGTest {
    ...
    public void testGetPDGs3() {
        ...
        assertEquals(250, sdg.getPDGs().size());
    }
    ...
    public void testGetClDGs3() {
        ...
        assertEquals(75, sdg.getClDGs().size());
    }
