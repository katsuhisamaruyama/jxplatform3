...
public class CFGStatementTest {
    ...
    public void testGetUseVariablesTest131_1() {
        ...
        assertEquals("this.map$Node.next;this.map.modCount;this.map.threshold;this.map$Node.hash;this.map$Node.value;"
    ...
    public void testGetUseVariablesTest131_2() {
        ...
        assertEquals("this.map$Node.next;this.map$Node.hash;this.map$Node.value;this.map$Node.key;this.map.table;this.map",
                TestUtil.asStrOfReference(result));
    }
