...
public class CFGGenTest {
    ...
    public static void main(String[] args) {
        CFGGenTest tester = new CFGGenTest();
...
//      tester.run("camel-3.14.0");  // OutOfMemoryError
//      tester.run("canal-1.1.6");   // OutOfMemoryError
//      tester.run("dbeaver-22.2.2");  // OutOfMemoryError
//      tester.run("druid-1.2.13");  // OutOfMemoryError
//      tester.run("hadoop-3.3.1");  // OutOfMemoryError
//      tester.run("netty-4.1.84");  // OutOfMemoryError
//      tester.run("rocketmq-5.0.0");  // OutOfMemoryError
//      tester.run("seata-1.5.2");  // OutOfMemoryError
    }
}
