...
class Character implements java.io.Serializable, Comparable<Character>, Constable {
    ...
    public static final class UnicodeBlock extends Subset {
        ...
        private static final int[] blockStarts = {
            ...
            0x10200,  // 10200..1022F; Old Italic
            0x10230,  // 10230..1024F; Gothic
            0x10250,  // 10250..1027F; Old Permic
            0x10280,  // 10280..1029F; Ugaritic
            0x102A0,  // 102A0..102DF; Old Persian
            0x102E0,  //               unassigned
    ...
    public static enum UnicodeScript {
        ...
        private static final int[] scriptStarts = {
            ...
            0x10200,  // 10200..10223; OLD_ITALIC
            0x10224,  // 10224..1022C; UNKNOWN
            0x1022D,  // 1022D..1022F; OLD_ITALIC
            0x10230,  // 10230..1024A; GOTHIC
            0x1024B,  // 1024B..1024F; UNKNOWN
            0x10250,  // 10250..1027A; OLD_PERMIC
            0x1027B,  // 1027B..1027F; UNKNOWN
            0x10280,  // 10280..1029D; UGARITIC
            0x1029E,  // 1029E       ; UNKNOWN
            0x1029F,  // 1029F       ; UGARITIC
            0x102A0,  // 102A0..102C3; OLD_PERSIAN
            0x102C4,  // 102C4..102C7; UNKNOWN
            0x102C8,  // 102C8..102D5; OLD_PERSIAN
            0x102D6,  // 102D6..102FF; UNKNOWN
            0x10400,  // 10400..1044F; DESERET
            0x10450,  // 10450..1047F; SHAVIAN
        ...
        private static final UnicodeScript[] scripts = {
            ...
            COMMON,                   // 102E1..102FB
            UNKNOWN,                  // 102FC..102FF
            OLD_ITALIC,               // 10200..10223
            UNKNOWN,                  // 10224..1022C
            OLD_ITALIC,               // 1022D..1022F
            GOTHIC,                   // 10230..1024A
            UNKNOWN,                  // 1024B..1024F
            OLD_PERMIC,               // 10250..1027A
            UNKNOWN,                  // 1027B..1027F
            UGARITIC,                 // 10280..1029D
            UNKNOWN,                  // 1029E
            UGARITIC,                 // 1029F
            OLD_PERSIAN,              // 102A0..102C3
            UNKNOWN,                  // 102C4..102C7
            OLD_PERSIAN,              // 102C8..102D5
            UNKNOWN,                  // 102D6..102FF
            DESERET,                  // 10400..1044F
            SHAVIAN,                  // 10450..1047F
            OSMANYA,                  // 10480..1049D
