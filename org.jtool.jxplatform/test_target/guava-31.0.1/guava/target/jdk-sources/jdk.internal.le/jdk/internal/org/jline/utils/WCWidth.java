...
public final class WCWidth {
    ...
    static Interval[] combining = {
            ...
            new Interval( 0x0F99, 0x0FBC ), new Interval( 0x0FC6, 0x0FC6 ), new Interval( 0x102D, 0x1020 ),
            new Interval( 0x1022, 0x1022 ), new Interval( 0x1026, 0x1027 ), new Interval( 0x1029, 0x1029 ),
