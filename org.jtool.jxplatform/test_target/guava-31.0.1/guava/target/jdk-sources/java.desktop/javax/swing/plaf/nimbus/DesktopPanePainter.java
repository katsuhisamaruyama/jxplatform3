...
final class DesktopPanePainter extends AbstractRegionPainter {
    ...
    private Path2D decodePath4() {
        ...
        path.curveTo(decodeAnchorX(1.3383333683013916f, 0.0f), decodeAnchorY(1.0f, 0.0f), decodeAnchorX(1.441666603088379f, -21.0f), decodeAnchorY(1.3102448152542114f, -37.5f), decodeX(1.4416666f), decodeY(1.3102448f));
        path.curveTo(decodeAnchorX(1.441666603088379f, 21.0f), decodeAnchorY(1.3102448152542114f, 37.5f), decodeAnchorX(1.5733332633972168f, 0.0f), decodeAnchorY(1.5840517282485962f, 0.0f), decodeX(1.5733333f), decodeY(1.5840517f));
    ...
    private Path2D decodePath5() {
        ...
        path.curveTo(decodeAnchorX(2.0f, 0.0f), decodeAnchorY(1.1982758045196533f, 0.0f), decodeAnchorX(1.806666612625122f, 27.5f), decodeAnchorY(1.5043102694915771f, -38.5f), decodeX(1.8066666f), decodeY(1.5043104f));
        path.curveTo(decodeAnchorX(1.806666612625122f, -27.5f), decodeAnchorY(1.5043102694915771f, 38.5f), decodeAnchorX(1.6766667366027832f, 0.0f), decodeAnchorY(1.778017282485962f, 0.0f), decodeX(1.6766667f), decodeY(1.7780173f));
