...
public class MediaSize extends Size2DSyntax implements Attribute {
    ...
    public static final class JIS {
        ...
        /**
         * Specifies the JIS B0 size, 1020 mm by 1456 mm.
         */
        public static final MediaSize
            B0 = new MediaSize(1020, 1456, Size2DSyntax.MM, MediaSizeName.JIS_B0);

        /**
         * Specifies the JIS B1 size, 728 mm by 1020 mm.
         */
        public static final MediaSize
            B1 = new MediaSize(728, 1020, Size2DSyntax.MM, MediaSizeName.JIS_B1);
