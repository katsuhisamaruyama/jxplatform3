...
final class SliderThumbPainter extends AbstractRegionPainter {
    ...
    private Path2D decodePath2() {
        ...
        path.curveTo(decodeAnchorX(0.6092391610145569f, -0.7485208875763871f), decodeAnchorY(0.4071640372276306f, 1.0961437978948614f), decodeAnchorX(0.6155303120613098f, -0.7499879392488253f), decodeAnchorY(2.595454692840576f, -1.0843510220300886f), decodeX(0.6155303f), decodeY(2.5954547f));
        path.closePath();
        return path;
    }
