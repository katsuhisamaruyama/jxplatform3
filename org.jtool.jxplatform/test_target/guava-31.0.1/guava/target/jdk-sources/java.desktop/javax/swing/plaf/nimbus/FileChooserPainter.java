...
final class FileChooserPainter extends AbstractRegionPainter {
    ...
    private Color color6 = decodeColor("nimbusBase", 0.0077680945f, -0.51781024f, 0.3490196f, 0);
    ...
    private Color color89 = decodeColor("nimbusBase", -0.0028941025f, -0.5906323f, 0.4078431f, 0);
    ...
    private Color color102 = decodeColor("nimbusBase", -0.57865167f, -0.6357143f, -0.007843137f, 0);
    private Color color104 = decodeColor("nimbusBase", -0.0028941025f, -0.5408867f, -0.09411767f, 0);
    ...
    private Color color111 = decodeColor("nimbusBase", -0.0028941025f, -0.5338625f, -0.12549022f, 0);
    ...
    private Color color114 = decodeColor("nimbusBase", -0.0028941025f, -0.5234694f, -0.1647059f, 0);
    ...
    private Paint decodeGradient3(Shape s) {
        ...
        float h = (float)bounds.getHeight();
        return decodeGradient((0.5f * w) + x, (0.0f * h) + y, (0.5f * w) + x, (1.0f * h) + y,
                new float[] { 0.04191617f,0.10229342f,0.16467066f,0.24550897f,0.3263473f,0.6631737f,1.0f },
                new Color[] { color11,
    ...
    private Paint decodeGradient6(Shape s) {
        ...
        float h = (float)bounds.getHeight();
        return decodeGradient((0.5f * w) + x, (0.0f * h) + y, (0.5f * w) + x, (1.0f * h) + y,
                new float[] { 0.0f,0.12724552f,0.25449102f,0.62724555f,1.0f },
                new Color[] { color21,
    ...
    private Paint decodeGradient30(Shape s) {
        ...
        return decodeGradient((1.0f * w) + x, (0.0f * h) + y, (0.0f * w) + x, (1.0f * h) + y,
                ...
                new Color[] { color102,
                            ...
                            color35,
                            decodeColor(color35,color102,0.5f),
                            color102});
    }
