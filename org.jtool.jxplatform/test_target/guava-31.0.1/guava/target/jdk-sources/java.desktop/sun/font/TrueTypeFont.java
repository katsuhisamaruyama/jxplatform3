...
public class TrueTypeFont extends FileFont {
   ...
   /* -- Tags for required TrueType tables */
    ...
    public static final short ENGLISH_LOCALE_ID = 0x0409; // 1023 decimal
...
//     }
    ...
    private static void createLCIDLanguageCompatibilityMap() {
        ...
        short[] sarr;
        sarr = new short[] { 1021, 3079, 5127, 2055, 4102, };
        map.put("de", sarr);
        ...
        map.put("it", sarr);
        sarr = new short[] { 1026, 5132, 6156, 2060, 3084, 4108, };
        map.put("fr", sarr);
        sarr = new short[] { 1024, 12298, 14346, 2058, 8202, 19466, 17418, 9226, 13322, 5130, 7178, 11274, 16394, 4106, 10250, 6154, 18442, 20490, 15370, };
        map.put("es", sarr);
