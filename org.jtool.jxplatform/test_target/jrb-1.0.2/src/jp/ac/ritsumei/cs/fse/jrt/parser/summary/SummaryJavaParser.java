/* Generated By:JavaCC: Do not edit this line. SummaryJavaParser.java */
...
public class SummaryJavaParser implements SummaryJavaParserConstants {
 ...
 *****************************************/
  ...
  String name;
    ...
    case IMPLEMENTS:
      ...
      name = NameList();
                                       jclass.setSuperClassNameList(name);
      break;
    default:
      jj_la1[8] = jj_gen;
      ;
  ...
  static final public void VariableDeclarator(JavaModifier modifier, String type) throws ParseException {
    VariableDeclaratorId(modifier, type);
    switch ((jj_ntk==-1)?jj_ntk():jj_ntk) {
    case ASSIGN:
  ...
  static final public void VariableDeclaratorId(JavaModifier modifier, String type) throws ParseException {
  String name;
  String array = "";
    jj_consume_token(IDENTIFIER);
                   name = token.image;
  ...
  String type;
    ...
    type = ResultType();
    MethodDeclarator(modifier, type);
    switch ((jj_ntk==-1)?jj_ntk():jj_ntk) {
    case THROWS:
  ...
  static final public void MethodDeclarator(JavaModifier modifier, String type) throws ParseException {
  ...
  static final public void FormalParameters(SummaryJavaMethod jmethod) throws ParseException {
    jj_consume_token(LPAREN);
    switch ((jj_ntk==-1)?jj_ntk():jj_ntk) {
    case BOOLEAN:
    case BYTE:
  ...
  static final public void FormalParameter(SummaryJavaMethod jmethod) throws ParseException {
  String type;
    switch ((jj_ntk==-1)?jj_ntk():jj_ntk) {
    case FINAL:
      jj_consume_token(FINAL);
  ...
  static public SummaryJavaParserTokenManager token_source;
  ...
  public SummaryJavaParser(java.io.InputStream stream) {
    ...
    token_source = new SummaryJavaParserTokenManager(jj_input_stream);
    token = new Token();
    jj_ntk = -1;
    jj_gen = 0;
  ...
  public SummaryJavaParser(java.io.Reader stream) {
    if (jj_initialized_once) {
      System.out.println("ERROR: Second call to constructor of static parser.  You must");
      System.out.println("       either use ReInit() or set the JavaCC option STATIC to false");
      System.out.println("       during parser generation.");
  ...
  public SummaryJavaParser(SummaryJavaParserTokenManager tm) {
    if (jj_initialized_once) {
      System.out.println("ERROR: Second call to constructor of static parser.  You must");
      System.out.println("       either use ReInit() or set the JavaCC option STATIC to false");
      System.out.println("       during parser generation.");
  ...
  public void ReInit(SummaryJavaParserTokenManager tm) {
    token_source = tm;
    token = new Token();
    jj_ntk = -1;
    jj_gen = 0;
